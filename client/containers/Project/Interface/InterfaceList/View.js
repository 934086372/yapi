      ...
      const columns = [
        {
          ...
          width: 140,
          render(_,item){
             return <p style={{ fontWeight: 'bold'}}>{item.name}</p>;
          }
        },
        {
          title: '参数类型',
        ...
        },
        {
          ...
          width: 100,
          render(_,item){
            return item.required == '是' ? (<p style={{ color : 'red'}}>是</p>) :(<p>否</p>);
          }
        },
        {
          title: '示例',
      ...
      <div className="caseContainer">
        ...
        <div className="panel-view">         
          <Row className="row">
            ...
            <Col span={4}>{formatTime(up_time)}</Col>
            <Col span={4} className="colKey">
              状&emsp;&emsp;态：
            </Col>
            <Col span={4} className={'tag-status ' + this.props.curData.status}>
          ...
          <Row className="row">
            ...
            <Col span={18} className="colName" style={{ fontWeight : 'bold'}}>
              {title}
            </Col> 
          </Row>  
          <Row className="row">
            ...
            >
              ...
              <span className="colValue" style={{ color: '#f47023', fontWeight: 'bold'}}>
        ...
        {this.props.curData.desc && <h2 className="interface-title">返回示例</h2>}
        {this.props.curData.desc && (   
          <div>   
            <AceEditor data={this.props.curData.desc} readOnly={true} mode="json" style={{ minHeight: 300 }} />
          </div>
        )}
